...
const COURSES = [
  ...
  /* ── v1.3 추가 골프장 (호남·영남) ── */
  { id: "gunsan", name: "군산 CC", eng: "Gunsan Country Club", region: "호남", city: "전북 군산", addr: "전북특별자치도 군산시", lat: 35.8927, lng: 126.6528, type: "퍼블릭", holes: 81, par: 72, len: "7,020m", rating: 4.3, ratingN: 688, green: { wd: 120000, we: 170000 }, caddy: 145000, cart: 95000, hue: 127, tags: ["국내 최대 81홀", "노캐디 선택", "골프텔"], facilities: ["골프텔", "클럽하우스", "레스토랑", "연습장"], desc: "단일 골프장 국내 최대 81홀. 새벽부터 밤까지 티타임이 많아 당일 빈자리가 자주 나옵니다." },
  ...
  { id: "elysian", name: "엘리시안 제주", eng: "Elysian Jeju", region: "제주", city: "제주 조천", addr: "제주특별자치도 제주시 조천읍", lat: 33.37478, lng: 126.37775, type: "퍼블릭", holes: 18, par: 72, len: "6,380m", rating: 4.1, ratingN: 334, green: { wd: 140000, we: 185000 }, caddy: 150000, cart: 95000, hue: 125, tags: ["공항 30분", "실속"], facilities: ["클럽하우스", "레스토랑"], desc: "조천의 실속형 18홀. 공항에서 30분이라 도착 당일 오후 라운드로 딱입니다." },
